...
type EconomicsConfig struct {
	MintLevel      []MintInfo // 几个增发阶段
	MinimumRation  *big.Int   // 最终的最小增发率，保持稳定
	InitialSupply  *big.Int   // 创世代币数量, 以 10^-8 Memo 为单位
	InitialTarget  *big.Int   // 目标第一次增发代币数, 以 10^-8 Memo 为单位，往后开始减半
	...
	SizeSimulate     SizeSimulateFunction     // 模拟每天订单数据量大小
	PriceSimulate    PriceSimulateFunction    // 模拟每天订单价格大小
	DurationSimulate DurationSimulateFunction // 模拟每天订单的平均时间
	ProviderSimulate ProviderSimulateFunction // 模拟每天新增Provider数
...
func DefaultEconomicsConfig() *EconomicsConfig {
	return &EconomicsConfig{
		...
		KeeperPledge:   big.NewInt(5000_0000_0000_0000),     // 五千万 Memo
		ProviderPledge: big.NewInt(10_0000_0000_0000),       // 十万 Memo
